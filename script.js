...
function sendRequest(btn) {
    clicked1 = document.querySelector(".left .active").innerText;
    clicked2 = document.querySelector(".right .active").innerText;
